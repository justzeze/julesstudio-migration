  ...
  const videos = [
    {
      "@context": "https://schema.org",
      "@type": "VideoObject",
      name: "Vidéo d'ambiance — Jules Studio",
      description:
        "Vidéo d'ambiance décorative du site Jules Studio, studio de web design et Webflow à Paris.",
      thumbnailUrl: thumbnail,
      uploadDate,
      contentUrl:
        "https://s3.amazonaws.com/webflow-prod-assets/697be174b8224c11c814a60e/697c72ff2f64b42254f72b34_best%20bg%20video%20V2.mp4",
    },
    {
      "@context": "https://schema.org",
      "@type": "VideoObject",
      name: "Aperçu projets — Jules Studio",
      description:
        "Aperçu d'un projet de site web réalisé par Jules Studio.",
      thumbnailUrl: thumbnail,
      uploadDate,
      embedUrl:
        "https://iframe.mediadelivery.net/embed/651531/684150da-f1fd-4cb8-8e2a-09e245ab1ff8",
    },
  ];
...
export function ProjectVideosJsonLd({
  projects,
}: {
  ...
  const videos = projects
    .filter((p) => p.videoUrl)
    .map((p) => {
      const isEmbed = p.videoUrl!.includes("iframe.mediadelivery.net") || p.videoUrl!.includes("player.mediadelivery.net");
      return {
        "@context": "https://schema.org",
        "@type": "VideoObject",
        name: `Aperçu projet ${p.name} — Jules Studio`,
        description: `Aperçu vidéo du projet ${p.name} réalisé par Jules Studio, studio de web design à Paris.`,
        thumbnailUrl: p.image || "https://julesstudio.fr/opengraph-image",
        uploadDate,
        ...(isEmbed ? { embedUrl: p.videoUrl } : { contentUrl: p.videoUrl }),
      };
    });
